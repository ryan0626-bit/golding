            ...
            {showSuccess ? (
              <div style={{ justifySelf: "center" }}>
                <div className={classes.successIcon}>
                  <Typography variant="h4"><CheckCircleIcon color="primary" /></Typography>
                </div>
                <div className={classes.successText}><Typography variant="h5">Request Submitted</Typography></div>
                <div className={classes.thankYouText}><Typography>Thank You! Our team will reach out to you as soon as possible.</Typography></div>
              </div>
            ) : (
