        ...
        <ClickAwayListener onClickAway={handleHideBox}>
          <Box className={classes.messageContainer} boxShadow={6}>
            ...
            <Box className={classes.form} boxShadow={0.3}>
              ...
              <TextField label="Mobile Phone" className={classes.textField} />
              <TextField label="Message" multiline rowsMax={5} className={classes.textField} />
            </Box>
            ...
            <div className={classes.bottomMessageBox}>
              ...
              <Button className={classes.send} color="primary" variant="contained" size="large">
                Send
              </Button>
            </div>
          </Box>
